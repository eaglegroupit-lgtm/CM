...
export function CustomerCreateDialog() {
  return (
    <EntityDialog triggerLabel="New Customer" title="Create Customer">
      {(close) => <CustomerForm onDone={close} />}
    </EntityDialog>
  );
}
...
export function CustomerForm({ onDone }: { onDone: () => void }) {
  ...
  const form = useForm<FormInput, unknown, FormValues>({
    ...
    defaultValues: { name: "", phone: "", address: "", state: "Tamil Nadu", gstin: "" },
  });
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="e.g. Sri Ranga Constructions" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
